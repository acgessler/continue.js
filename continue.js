 ...
 *      // point in time. To get a callback when the computation finished,
 *      // simply add it as a final job using AddJob().
 *      c.Schedule();
 *
 *   For more information on adding jobs, see the AddJob() member function.
 *
 */
